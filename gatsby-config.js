...
module.exports = {
  ...
  siteMetadata: {
    ...
    siteHeadline: `Advancing Indigenous Language Technologies working group (AILT)`,
    // Will be used to generate absolute URLs for og:image etc.

    // Will be used to generate absolute URLs
    //siteUrl: `https://arizona-linguistics.github.io/ailt`,
    siteUrl: `https://ailt.arizona.edu`,
    // Used for SEO
    siteDescription: `This is the homepage for the Advancing Indigenous Language Technologies (AILT) working group.`,
